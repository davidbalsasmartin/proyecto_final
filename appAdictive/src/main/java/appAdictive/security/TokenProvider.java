...
import static appAdictive.util.Constants.SECRET_KEY;
import static appAdictive.util.Constants.TOKEN_SECONDS;
...
public class TokenProvider implements Serializable {
	...
	private static final long serialVersionUID = 2923637597728390300L;
    ...
    public String generateToken(Authentication authentication) {
        ...
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + TOKEN_SECONDS))
                .compact();
    }
